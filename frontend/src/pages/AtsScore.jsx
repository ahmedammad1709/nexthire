  ...
  return (
    <div className="min-h-screen px-5 py-14">
      <div className="mx-auto max-w-5xl">
        ...
        >
          <h2 className="font-display text-3xl font-semibold text-emerald-50">ATS Insight</h2>
          <p className="mt-3 text-emerald-100/70 max-w-2xl">
            Hook this page to your ATS backend when you’re ready. The homepage navigation is
            already wired.
          </p>

          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {['Keyword match', 'Semantic similarity', 'Skill coverage'].map((t) => (
              <div
                key={t}
